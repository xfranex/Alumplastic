    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="shadow rounded border border-gray-200 mt-6 bg-white">
            <div class="bg-gray-800 text-white py-3 px-4 rounded-t">
                <h3 class="text-center font-semibold text-lg">Editar Serie {{$serie->nombre}}</h3>
            </div>
            <div class="p-6">
                <form action="{{ route('series.update', $serie) }}" method="POST" class="space-y-6">
                    ...
                    @method('PUT')
                    <div>
                        <label for="nombre" class="block text-gray-700 font-semibold mb-2">Nombre de la Serie</label>
                    ...
                    <div class="flex flex-col sm:flex-row justify-center sm:space-x-4 space-y-4 sm:space-y-0">
                        ...
                        <a href="{{ route('series.index') }}" class="w-full sm:w-auto">
                            <button type="button"
