    ...
    <div class="md:px-32 py-8 w-full max-w-4xl mx-auto">
        <div class="shadow overflow-hidden rounded border border-gray-200">
            <div class="bg-gray-800 text-white py-3 px-6 rounded-t">
                <h3 class="text-center font-semibold text-lg">Editar el producto {{ $tipo->nombre_tipo_producto }}</h3>
            </div>
            <div class="bg-white p-6">
                <form action="{{ route('tipos.update', $tipo) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nombre_tipo_producto" id="nombre_tipo_producto"
                            class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring focus:border-blue-300"
                            value="{{ old('nombre_tipo_producto') ?? $tipo->nombre_tipo_producto }}">
