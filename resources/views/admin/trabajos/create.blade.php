                ...
                <form id="form-trabajo" method="POST" action="{{ route('trabajos.store') }}" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <div class="flex justify-center">
                        <div class="relative w-full max-w-lg aspect-[4/3] bg-gray-100">
                            <img id="image" class="absolute inset-0 w-full h-full object-cover" src="{{ old('cropped_image') }}"/>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="cropped_image" id="croppedImageInput" value="{{ old('cropped_image') }}"/>
